...
<html>
    ...
    <body>
        ...
        <p>These terms and conditions outline the rules and regulations for the use of EmySell's Website, located at https://dangtran862000.github.io/Emysell_website/index.html.</p>

        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use EmySell if you do not agree to take all of the terms and conditions stated on this page.</p>
        ...
        <p>We employ the use of cookies. By accessing EmySell, you agreed to use cookies in agreement with the EmySell's Privacy Policy. </p>

        <p>Most interactive websites use cookies to let us retrieve the user’s details for each visit. Cookies are used by our website to enable the functionality of certain areas to make it easier for people visiting our website. Some of our affiliate/advertising partners may also use cookies.</p>

        <h3><strong>License</strong></h3>

        <p>Unless otherwise stated, EmySell and/or its licensors own the intellectual property rights for all material on EmySell. All intellectual property rights are reserved. You may access this from EmySell for your own personal use subjected to restrictions set in these terms and conditions.</p>
