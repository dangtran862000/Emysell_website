          ...
          <div class="column">
            ...
            <table id="customers_total">
                <tr >
                    ...
                    <th style="width: 25%; text-align: center"><p id="sub_total"></p></th>
                </tr>
                <tr>
                    <td style="width: 22%; text-align: center; background-color: white; padding-top: 5%; padding-bottom: 5%;">DISCOUNT COUPON</th>
                    <th style="width: 25%; text-align: center"><p id="mycoupon">0%</p></th>
                </tr>
                <tr>
                    <td style="width: 22%; text-align: center; background-color: white; padding-top: 5%; padding-bottom: 5%;">TOTAL</th>
                    <th style="width: 25%; text-align: center"><p id="demo"><p id="other_total"></p></p></th>
                </tr>
            </table>
            </div>
